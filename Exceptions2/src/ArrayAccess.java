  ...
  public ArrayAccess() {
    ...
    inputField.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent event) {
        /*
         * Create a try block in which the application reads the number entered
        ...
        try {
          ...
          // Loop through all the values that have been added.
          for (int i = 0; i < index; i++) {
            // If a match is found anywhere, it's considered a duplicate!
            if (num == array[i]) {
              throw new DuplicateValueException();
            }
          }

          // Assign the value to array with the correct index.
          array[index] = num;
    ...
    retrieveField1.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent event) {
        /*
         * Create a try block in which the application reads from retrieveField1
         * the number the user wants to find in the array, then searches the
         * current array contents for the number. If the number is found, the
         * outputField should display all the indices in which the number was
         * found. If the number is not found, a NumberNotFoundException should
         * be thrown.
         */
    ...
    retrieveField2.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent event) {
        /*
         * Create a try block in which the application reads from retrieveField2
         * the index of a value in the array, then displays the value at that
         * index in the outputField. If the index input by the user is not a
         * number a NumberFormatException should be thrown. If the number input
         * by the user is outside the array bounds or represents an element in
         * which the application has not stored a value, an
